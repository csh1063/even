...
final class MyPageCell: UITableViewCell {
    ...
    private let styleIconView = UIImageView()
    ...
    private let topSeperator = UIView(backgroundColor: Theme.strokeSoft)
    private let bottomSeperator = UIView(backgroundColor: Theme.strokeSoft)
